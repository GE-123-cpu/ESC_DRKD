...
def main():
    parser = argparse.ArgumentParser(description='Retouch anomaly detection')
    parser.add_argument('--obj', type=str, default='OCT-Cirrus')
    parser.add_argument('--data_type', type=str, default='OCT_Cirrus')
    parser.add_argument('--train_data_path', type=str, default='./Retinal_OCT/train/NORMAL')
    parser.add_argument('--test_path', type=str, default='./Retouch/Image/RETOUCH-TrainingSet-Cirrus')

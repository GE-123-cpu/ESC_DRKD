...
def main():
    ...
    parser.add_argument('--ab1', type=str, default='./Retinal_OCT/test/CNV')
    parser.add_argument('--ab2', type=str, default='./Retinal_OCT/test/DME')
    parser.add_argument('--ab3', type=str, default='./Retinal_OCT/test/DRUSEN')

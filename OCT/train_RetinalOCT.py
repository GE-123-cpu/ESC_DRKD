...
def main():
    parser = argparse.ArgumentParser(description='OCT anomaly detection')
    parser.add_argument('--obj', type=str, default='OCT')
    parser.add_argument('--data_type', type=str, default='OCT_classifier')
    ...
    parser.add_argument('--ab1', type=str, default='D:/chenku/OCT_anomaly/test/CNV')
    parser.add_argument('--ab2', type=str, default='D:/chenku/OCT_anomaly/test/DME')
    parser.add_argument('--ab3', type=str, default='D:/chenku/OCT_anomaly/test/DRUSEN')
...
def train(proj_layer, decoder, epoch, train_loader, optimizer_proj, optimizer_distill, log, encoder):
    ...
    for (data, img) in tqdm(train_loader):
        ...
        rec_loss = cos(output_noise[1], input[1]) + cos(output_noise[2], input[2])

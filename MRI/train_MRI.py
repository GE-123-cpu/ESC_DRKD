...
def main():
    ...
    parser.add_argument('--train_data_path', type=str, default='./MRI/Training/notumor')
    parser.add_argument('--test_normaldata_path', type=str, default='./MRI/Testing/notumor')
    parser.add_argument('--ab1', type=str, default='./MRI/Testing/glioma')
    parser.add_argument('--ab2', type=str, default='./MRI/Testing/meningioma')
    parser.add_argument('--ab3', type=str, default='./MRI/Testing/pituitary')

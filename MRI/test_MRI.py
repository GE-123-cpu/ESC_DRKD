...
def main():
    ...
    parser.add_argument('--checkpoint_dir',
                        type=str,
                        default='./ablation/OCT_classifier/OCT/seed_ab1_6642/OCT_2024-11-11-9219_model.pth')
    parser.add_argument("--grayscale", action='store_true', help='color or grayscale input image')
    parser.add_argument('--batch_size', type=int, default=1)
    parser.add_argument('--img_size', type=int, default=256)
    parser.add_argument('--seed', type=int, default=9788)

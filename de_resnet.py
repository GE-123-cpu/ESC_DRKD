...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, a, b) -> Tensor:
        ...
        feature_b = self.layer2(feature_a + a)  # 256*16*16->128*32*32
        feature_c = self.layer3(feature_b + b)  # 128*32*32->64*64*64
    ...
    def forward(self, x: Tensor, a, b) -> Tensor:
        return self._forward_impl(x, a, b)
